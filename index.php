<html>  
    ...
    <body>
        ...
        <body>
            ...
            <div class="display">
            <?php
                // Add comment in front of $connect while editing/debugging non-database related stuff for no lag.
                ...
                {
                    $query .= "INSERT INTO info(year, category, winner, entity) VALUES ('".$row["year"]."', '".$row["category"]."', '".$row["winner"]."', '".$row["entity"]."'); ";  // Make Multiple Insert Query 
                    $table_data .= '
                                    <tr>
                                        <td>'.$row["year"].'</td>
                                        <td>'.$row["category"].'</td>
